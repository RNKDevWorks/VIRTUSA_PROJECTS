<h1 align="center"> Smart Monthly Expense Tracker </h1>

* The Smart Monthly Expense Tracker is a Python-based console application that helps users record, manage, and analyze their daily expenses.
